...
deb_install() {
	...
	sudo apt install -y fonts-font-awesome feh policykit-1-gnome nala alacritty flameshot thunar lxappearance pavucontrol neovim flatpak lightdm lightdm-gtk-greeter
...
arch_install() {
	...
	sudo pacman -S --noconfirm awesome-terminal-fonts feh alacritty picom flameshot thunar polkit-gnome lxappearance pavucontrol neovim flatpak lightdm lightdm-gtk-greeter
